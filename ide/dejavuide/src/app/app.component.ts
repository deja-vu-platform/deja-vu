...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.selectedWidget.updateWidgetMap(this.allWidgets);
    Widget.addWidgetToWidgetMap(this.allWidgets, this.selectedWidget);
    const innerWidget1 = new BaseWidget('test inner1',
        { height: 100, width: 200 }, 'img', '/', '1234');
    innerWidget1.updateWidgetMap(this.allWidgets);
    innerWidget1.addWidgetToAllWidgets();
    ...
    innerWidget2.updateWidgetMap(this.allWidgets);
    innerWidget2.addWidgetToAllWidgets();
    ...
    innerWidget21.updateWidgetMap(this.allWidgets);
    innerWidget21.addWidgetToAllWidgets();
